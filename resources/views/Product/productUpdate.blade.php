            ...
            <div class="col-md-6">
                <form method="POST" action="{{ route('product.update', $productData->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="pr_image" class="form-control" id="product-image"
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="pr_price" class="form-control" id="product-price" value="{{ $productData->price }}"
                        >
